...
document.getElementById('btnRetry').addEventListener('click', function () {
    ...
    document.getElementById("inputWindowMin").style.visibility = 'visible';
    document.getElementById("inputWindowMax").style.visibility = 'visible';
...
document.getElementById('btnStart').addEventListener('click', function () {
    ...
    document.getElementById("inputWindowMin").style.visibility = 'hidden';
    document.getElementById("inputWindowMax").style.visibility = 'hidden';
